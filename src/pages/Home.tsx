  ...
  return (
    <>
      ...
      <p>
        ...
        strategy plan to improve the situation of their digital infrastructure.
      </p>
      <p>It has 3 major sections:</p>
      <p>
        - The analysis section provides facts about individual countries, which help the user to find a country
      ...
      <p>
        - The discussion section allows everybody to discuss individual measures and strategies and how they might be
        modified to better fit any given country.
      </p>
      <p>
